exports.on = function(app) {
    ...
    app.post(preRestApi + '/addHouse',[middleware.tokenAuth], function(req, res) {
        ...
        */
        ...
        house.addHouse(name,city,area,owner,address,houseNumber,totalFloor,floor,floor2,room,price,hostName,hostPhone,hostGender,houseConfig,ping,parking,traffic,life,educate,saleType,saleInfo,photo,annex,remark,belongType,belongId,(result,data)=>{
                ...
                house.mkdirFileFolder(folderPath,(result)=>{
                    if(result){
                        house.moveFiles(photo,annex,folderPath,(result)=>{
                            if(result){
                                res.send(response);
                                house.watermarkJob(photo,folderPath,()=>{})
                            }else{
    ...
    app.put(preRestApi + '/editHouse',[middleware.tokenAuth], function(req, res) {
        ...
        */
        ...
        const belongType = req.body.belongType
        const belongId = req.body.belongId
        house.editHouse(id,name,city,area,owner,address,houseNumber,totalFloor,floor,floor2,room,price,hostName,hostPhone,hostGender,houseConfig,ping,parking,traffic,life,educate,saleType,saleInfo,photo,annex,remark,belongType,belongId,(result,data)=>{
            // response.status = result;
            // response.data = data
            // res.send(response);
    ...
    app.post(preRestApi + '/dealHouse',[middleware.tokenAuth,middleware.checkIsEmployee], function(req, res) {
        /* 
        #swagger.security = [{
               "apiKeyAuth": []
        }] 
          #swagger.parameters['obj'] = {
            in: 'body',
            description: 'deal house',
            schema: {
                id: '636fce410653bf00212481a5',
                actualPrice: 12000,
                serviceCharge: 10000,
                startRentDate : '2022/05/11',
                endRentDate : '2022/10/11',
                companyId: '636fce410653bf00212481a5',
            }
        }
        */
        ...
        house.dealHouse(id,userId,companyId,actualPrice,serviceCharge,startRentDate,endRentDate,(result,data)=>{
            const response = {
                'status':result,
                'data':data
            }
