exports.on = function(app) {
    ...
    app.put(preRestApi + '/editHouse',[middleware.tokenAuth], function(req, res) {
        ...
        */
        ...
        const belongId = req.body.belongId
        const isRoofAnnex = req.body.isRoofAnnex
        house.editHouse(id,name,city,area,owner,address,houseNumber,totalFloor,floor,floor2,room,price,hostName,hostPhone,hostGender,houseConfig,ping,parking,traffic,life,educate,saleType,saleInfo,photo,annex,remark,belongType,belongId,isRoofAnnex,(result,data)=>{
            const newPhoto = [];
            const newAnnex = [];
