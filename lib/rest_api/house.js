exports.on = function(app) {
    ...
    app.post(preRestApi + '/addHouse',[middleware.tokenAuth], function(req, res) {
        ...
        */
        ...
        house.addHouse(name,city,area,owner,address,houseNumber,floor,room,price,houseConfig,ping,parking,traffic,life,educate,saleType,saleInfo,photo,annex,remark,(result,data)=>{
    ...
    app.get(preRestApi + '/getHouses', function(req, res) {
        ...
        */
        ...
        house.getHouses(start,count,timeSort,priceSort,pingSort,minPrice,maxPrice,minPing,maxPing,minRoom,maxRoom,minFloor,maxFloor,buildingType,typeOfRental,city,area,parking,pet,manager,garbage,smoke,cook,textQuery,isDelete,(result,data)=>{
            response.status = result;
            response.data = data
            res.send(response);
        })
    ...
    app.put(preRestApi + '/editHouse',[middleware.tokenAuth], function(req, res) {
        ...
        */
        ...
        house.editHouse(id,name,city,area,owner,address,houseNumber,floor,room,price,houseConfig,ping,parking,traffic,life,educate,saleType,saleInfo,photo,annex,remark,(result,data)=>{
            // response.status = result;
            // response.data = data
            // res.send(response);
