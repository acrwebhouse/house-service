exports.on = function(app) {
    ...
    app.post(preRestApi + '/addHouse',[middleware.tokenAuth], function(req, res) {
        ...
        */
        ...
        house.addHouse(name,city,area,owner,address,houseNumber,floor,room,price,hostName,hostPhone,hostGender,houseConfig,ping,parking,traffic,life,educate,saleType,saleInfo,photo,annex,remark,belongType,belongId,(result,data)=>{
    ...
    app.put(preRestApi + '/editHouse',[middleware.tokenAuth], function(req, res) {
        ...
        */
        ...
        const belongType = req.body.belongType
        const belongId = req.body.belongId
        house.editHouse(id,name,city,area,owner,address,houseNumber,floor,room,price,hostName,hostPhone,hostGender,houseConfig,ping,parking,traffic,life,educate,saleType,saleInfo,photo,annex,remark,belongType,belongId,(result,data)=>{
            // response.status = result;
            // response.data = data
            // res.send(response);
