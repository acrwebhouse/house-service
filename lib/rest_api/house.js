exports.on = function(app) {
    ...
    app.put(preRestApi + '/editHouse',[middleware.tokenAuth , middleware.checkCanEdit], function(req, res) {
        /* #swagger.security = [{
               "apiKeyAuth": []
        }] 
        #swagger.parameters['obj'] = {
        ...
        */
        ...
        house.editHouse(id,account,password,name,gender,roles,rolesInfo,houseIds,phone,mail,address,(result,data)=>{
            response.status = result;
            response.data = data
            res.send(response);
        })
