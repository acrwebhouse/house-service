exports.on = function(app) {
    ...
    app.post(preRestApi + '/addHouse',[middleware.tokenAuth], function(req, res) {
        ...
        */
        ...
        house.addHouse(name,city,area,owner,address,houseNumber,floor,room,price,hostName,hostPhone,hostGender,houseConfig,ping,parking,traffic,life,educate,saleType,saleInfo,photo,annex,remark,(result,data)=>{
    ...
    app.put(preRestApi + '/editHouse',[middleware.tokenAuth], function(req, res) {
        ...
        */
        ...
        const hostPhone = req.body.hostPhone
        const hostGender = req.body.hostGender
        house.editHouse(id,name,city,area,owner,address,houseNumber,floor,room,price,hostName,hostPhone,hostGender,houseConfig,ping,parking,traffic,life,educate,saleType,saleInfo,photo,annex,remark,(result,data)=>{
            // response.status = result;
            // response.data = data
            // res.send(response);
