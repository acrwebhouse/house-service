exports.on = function(app) {
    ...
    app.get(preRestApi + '/getHouses',[middleware.tokenAuth], function(req, res) {
        ...
        */
        ...
        house.getHouses(start,count,timeSort,priceSort,pingSort,minPrice,maxPrice,minPing,maxPing,minRoom,maxRoom,minFloor,maxFloor,buildingType,typeOfRental,city,area,parking,pet,manager,garbage,smoke,cook,isDelete,(result,data)=>{
            response.status = result;
            response.data = data
            res.send(response);
        })
