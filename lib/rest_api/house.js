exports.on = function(app) {
    ...
    app.post(preRestApi + '/addHouse',[middleware.tokenAuth], function(req, res) {
        ...
        */
        ...
        house.addHouse(name,city,area,owner,address,houseNumber,floor,room,price,hostName,hostPhone,houseConfig,ping,parking,traffic,life,educate,saleType,saleInfo,photo,annex,remark,(result,data)=>{
    ...
    app.put(preRestApi + '/editHouse',[middleware.tokenAuth], function(req, res) {
        ...
        */
        ...
        const hostName = req.body.hostName
        const hostPhone = req.body.hostPhone
        house.editHouse(id,name,city,area,owner,address,houseNumber,floor,room,price,hostName,hostPhone,houseConfig,ping,parking,traffic,life,educate,saleType,saleInfo,photo,annex,remark,(result,data)=>{
            // response.status = result;
            // response.data = data
            // res.send(response);
