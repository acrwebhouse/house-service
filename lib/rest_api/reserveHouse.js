exports.on = function(app) {
    ...
    app.get(preRestApi + '/getReserveHousesOnlyClient',[middleware.tokenAuth], function(req, res) {
    ...
    app.put(preRestApi + '/editReserveHouseOnlyHost',[middleware.tokenAuth], function(req, res) {
        /* #swagger.security = [{
               "apiKeyAuth": []
        }] 
        #swagger.parameters['obj'] = {
        ...
        reserveHouse.getReserveHouse(id,(result,data)=>{
            if(result == true){
                if(data.host == host){
                    ...
                    response.status = false;
                    response.data = 'user is not host'
                    res.send(response)
                }
            }else{
                response.status = result;
    ...
    app.get(preRestApi + '/getReserveHouseOnlyClient',[middleware.tokenAuth], function(req, res) {
