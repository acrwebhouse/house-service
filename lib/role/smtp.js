...
function getEditHouseNotifyContent(name,editName,orgHouse,editHouse){

}

function sendEditHouseNotifyMail(toMail,name,editName,orgHouse,editHouse,callback){
    const subject = '[租屋物件更改通知] - ' + utilsValue.getCurrentTime()
    const content = getEditHouseNotifyContent(name,editName,orgHouse,editHouse);
