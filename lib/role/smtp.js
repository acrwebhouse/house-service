...
<table style="border-spacing: 0;border: 1px solid #333;border-collapse: collapse;">
    ...
    <tr>
        ...
        <td style="border:1px solid #000;">${orgHouse.room}</td>
        <td style="border:1px solid #000;">${editHouse.room}</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td style="border:1px solid #000;">${orgHouse.remark}</td>
        <td style="border:1px solid #000;">${editHouse.remark}</td>
    </tr>
    <tr>
