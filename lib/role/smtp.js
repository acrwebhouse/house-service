...
<table style="border-spacing: 0;border: 1px solid #333;border-collapse: collapse;width:100%;">
    ...
    <tr>
        ...
        <td style="border:1px solid #000;">${getPhoto(orgHouse)}</td>
        <td style="border:1px solid #000;">${getPhoto(editHouse)}</td>
    </tr>
    <tr>
        <td style="border:1px solid #000;">附件</td>
        <td style="border:1px solid #000;">${getAnnex(orgHouse)}</td>
        <td style="border:1px solid #000;">${getAnnex(editHouse)}</td>
    </tr>
</table>
`
