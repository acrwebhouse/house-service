...
function editEditHouse(id,name,city,area,owner,address,houseNumber,floor,room,price,config,ping,parking,traffic,life,educate,saleType,saleInfo,photo,annex,remark,callback) {
    const user = {}
    if (utilsValue.isValid(id)){
        user.id = id
    }
