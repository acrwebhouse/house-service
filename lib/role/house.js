...
function addHouse(name,city,area,owner,address,houseNumber,floor,room,price,hostName,hostPhone,hostGender,houseConfig,ping,parking,traffic,life,educate,saleType,saleInfo,photo,annex,remark,callback) {
    const house = {}
...
function editHouse(id,name,city,area,owner,address,houseNumber,floor,room,price,hostName,hostPhone,hostGender,houseConfig,ping,parking,traffic,life,educate,saleType,saleInfo,photo,annex,remark,callback) {
    const house = {}
