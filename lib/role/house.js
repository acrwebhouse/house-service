...
function getHouses(start,count,timeSort,priceSort,pingSort,minPrice,maxPrice,minPing,maxPing,minRoom,maxRoom,minFloor,maxFloor,buildingType,typeOfRental,city,area,parking,pet,manager,garbage,smoke,cook,textQuery,isDelete,callback) {
        ...
        if (error) {
            ...
            if(body){
                ...
                if(body.status  == true && body.data && body.data.owner){
                    ...
                    getUserById(owner,isDelete,(result,msg)=>{
                        if(result){
